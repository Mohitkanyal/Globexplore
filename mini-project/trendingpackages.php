...
<!-- Custom CSS -->
<link href="css/style1.css?v=20" rel='stylesheet' type='text/css' />
...
{				?>		
						  <tr>
							...
							<td><a href="updatepackages.php?pid=<?php echo htmlentities($result->PackageId);?>"><button type="button" class="btn btn-primary btn-block" style="width:50%">Update Details</button></a><br />

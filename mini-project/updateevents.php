...
if(isset($_POST['submit'])) 
{
        ...
        $sql = "UPDATE events SET PackageName = :pname, PackageDetails = :pdetails, PackageDay1 = :pday1, PackageDay2 = :pday2, PackageDay3 = :pday3, PackageDay4 = :pday4, PackageDay5 = :pday5 WHERE PackageId = :pid";
...
<link href="css/style1.css?v=3" rel='stylesheet' type='text/css' />
...
<h3 style="color:white">Update Event</h3>
						
<?php 
$pid=intval($_GET['pid']);
$sql = "SELECT * from events where PackageId=:pid";
$query = $dbh -> prepare($sql);
...
{	?>
                            ...
                            action="updateevents.php?pid=<?php echo htmlentities($result->PackageId);?>">
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label" style="color:white">Event Name</label>
									<div class="col-sm-8">
...
<!--  --><div class="form-group">    
									<label for="focusedinput" class="col-sm-2 control-label"style="color:white">Event Details</label>
									<div class="col-sm-8">
                                ...
                                <div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label"style="color:white">Event Day 1</label>
									<div class="col-sm-8">
                                ...
                                <div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label"style="color:white">Event Day 2</label>
									<div class="col-sm-8">
                                ...
                                <div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label"style="color:white">Event Day 3</label>
									<div class="col-sm-8">
                                ...
                                <div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label"style="color:white">Event Day 4</label>
									<div class="col-sm-8">
                                ...
                                <div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label"style="color:white">Event Day 5</label>
									<div class="col-sm-8">

...
{	?>
<header >
<img class="card-img" src="uploads/<?php echo htmlentities($result->PackageTtd1Image);?>"  alt=""></a>
    </header>
    <div class="effect">
        <div class ="header-title">
        <h1><?php  echo htmlentities($result->PackageTtd1Name);?></h1>
        <!-- </div> -->
...
<!-- <section>
    ...
    <div class="links">
        ...
        {  ?>
      <a href="book1.php?pkgid=<?php echo htmlentities($result->PackageId);?>" > <button class="bttn">Book Now</button></a>
        <?php  }
        else{?>

...
<link href="css/style1.css?v=5" rel='stylesheet' type='text/css' />
...
{	?>
							...
							action="updateinternational.php?pid=<?php echo htmlentities($result->PackageId);?>">

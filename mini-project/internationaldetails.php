...
<head>
    ...
    <link rel="stylesheet" href="css/package.css?v=5">
...
$sql = "SELECT * FROM international WHERE PackageId=:pid";
        ...
        <div class="container">
            ...
            <div class="box">
                <div class="card">
                    ...
                    <a href="internationalitenary.php?pkgid=<?php echo htmlentities($result->PackageId);?>" class="bttn">All Details</a>
                </div>
                <div class="card">
                    ...
                    <p>&#x20B9;<?php echo htmlentities($result->PackagePrice);?></p>
                    <a href="internationalitenary1.php?pkgid=<?php echo htmlentities($result->PackageId);?>" class="bttn">All Details</a>
                </div>
            </div>
        </div>
    </section>

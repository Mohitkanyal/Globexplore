...
<!-- navbar -->
    ...
    <nav class="navbar" >
        <span><a >
         ...
         <ul class="nav-links">
            <li>
                <a href="dashboard.php" id="one" >Dashboard</a>
            </li>
            <!-- <li>
                <a href="#events" id="two" >Events</a>
            </li> -->
            <li>
                <a href="trendingpackages.php" id="three">Trending</a>
                
            </li>
            <li>
                <a href="tours.php" id="four">International</a>
            </li>
            <!-- <li>
                <a href="#about" id="five">About</a></li>
            </li> -->
            <li>
                <a href="users.php" id="five">Users</a>
            </li>

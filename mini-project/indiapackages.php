...
<div class="agile-grids">	
				...
				<div class="agile-tables">
					<div class="w3l-table-info"style="margin-top: -25px;">
...
{				?>		
						  <tr>
							...
							<td><?php echo htmlentities($result->PackageNameIndia);?></td>
							<td><?php echo htmlentities($result->PackagePrice);?></td>
							
							
							<td><a href="indiadetails.php?pkgid=<?php echo htmlentities($result->PackageId);?>"><button type="button" class="btn btn-primary btn-block" style="width:50%">View Details</button></a><br />
							<td><a href="updateindia.php?pid=<?php echo htmlentities($result->PackageId);?>"><button type="button" class="btn btn-primary btn-block" style="width:50%">Update Details</button></a><br />
